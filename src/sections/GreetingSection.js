...
const greetingData = [
  ...
  },
  {
    ...
    title: "이태웅 대표",
    content:
      "게임업계에는 게임이 정말 좋아서 이 일을 시작한 사람이 많아요.\n그런데 일하다 보면 내가 좋아하고 만들고 싶은 게임을 만들 기회는 정말 적어요.\n인생이란 게, 사회생활이란 게 내가 하고 싶은 것만 하고 살 수는 없더라고요.\n하지만 인생의 긴 여정에서 우리 회사에서 일한 시간이 내가 하고 싶은 일을 했던 시간,\n덕업일치를 이룬 시간, 애쓰지 않아도 일이 잘되는 그런 시간이 되었으면 좋겠어요.\n자신의 인생에서 그런 시간을 가질 수 있다면 의미가 있다고 생각해요. 우리 구성원들이 그런 시간을 여기서 가질 수 있다면, 창업하길 잘했다고 큰 보람을 느낄 것 같아요.저희는 그런 회사를 만들기 위해서 계속 노력할거고요."
  }
];
