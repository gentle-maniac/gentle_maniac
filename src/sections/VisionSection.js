...
const visionData = [
  {
    icon: Img.비전01,
    title: "글로벌 서브컬처 게임 제작",
    content:
      "페이트처럼 글로벌하게 롱런하는 서브컬처게임,\n한국에도 하나쯤은 있어야 하지 않을까?\n우리가 해보자! 우리의 IP로 유니버스를 만들어 보자!",
  },
  {
    icon: Img.비전02,
    title: "서브컬처 게임 전문 퍼블리셔",
    content:
      "서브컬처 게임 개발은 물론,\n성공적인 자체 서비스를 경험을 바탕으로\n서브컬처 게임 퍼블리셔로서 전세계 서브컬처 팬들을 만족시키는 회사가 되자!",
  },
  {
    icon: Img.비전03,
    title: "서브컬처 DNA를 잘 지켜나가자",
    content:
      "서브컬처 팬들을 만족시키기 위해서는 거기에 맞는 DNA가 필요하다.\n우리가 보유한 이런 DNA를 잘 유지하고 발전시키자!",
  },
];
